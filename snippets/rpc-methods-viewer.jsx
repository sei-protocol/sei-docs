...
const SEI_RPC_METHODS = [
  ...
  {"namespace":"debug","name":"debug_traceTransactionProfile","status":"limited","description":"Sei extension that traces a transaction and returns the trace plus a phase-by-phase timing profile of the trace execution.","seiNote":"Sei-specific extension (not part of upstream go-ethereum's debug namespace). Returns {trace, profile} where profile carries totalNanos, historicalDbLookupNanos, otherNanos, and per-phase timings. HTTP-only and subject to the max_trace_lookback_blocks historical guard.","params":[{"name":"hash","type":"DATA, 32 bytes","description":"Transaction hash to trace and profile.","example":"0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060"},{"name":"config","type":"object","description":"Optional tracer config.","example":"{\"tracer\":\"callTracer\"}"}]},
