...
* Various audit fixes`
  ...
  // Inline replacement for the sei-* link classes used in the source:
  // text-sei-maroon-100 hover:text-sei-maroon-200 bg-sei-grey-25 hover:bg-sei-grey-30
  // dark:text-sei-maroon-25 dark:hover:text-sei-cream dark:bg-sei-maroon-100/20 dark:hover:bg-sei-maroon-100/30
  const linkBaseStyle = () => ({
    ...
    <div>
      <div className="flex items-center justify-between mb-2 pb-4 mt-4">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 text-sm px-3 py-1.5 font-medium no-underline"
          style={{
            color: isDark ? 'var(--sei-maroon-25)' : 'var(--sei-maroon-100)',
            backgroundColor: isDark ? 'rgba(96, 0, 20, 0.2)' : 'var(--sei-grey-25)',
            transition: 'color 0.15s, background-color 0.15s'
