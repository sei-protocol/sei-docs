...
Filter by domain, then copy the install command from any card. Installing the set gives your assistant all of them; install just the ones you need to keep your assistant's context lean.
