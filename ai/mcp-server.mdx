...
| --- | --- | --- |
| `search_docs` | Search the official Sei docs | "How do I use the staking precompile?" |
| `get_supported_networks` | List supported networks | "Which Sei networks are available?" |
