...
export function Footer() {
	return (
		<footer style={{ backgroundColor: '#000000', color: '#ffffff', fontFamily: "'Inter', system-ui, sans-serif" }}>
			{/* Main links section */}
			<div style={{ maxWidth: '1440px', margin: '0 auto', padding: '40px 40px 0' }}>
				<div style={{ display: 'flex', gap: '60px', alignItems: 'flex-start' }}>
					...
					<div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '36px', fontSize: '12px', lineHeight: '1.2' }}>
						<div style={{ display: 'flex', gap: '80px', borderTop: '1px solid #333', paddingTop: '20px' }}>
