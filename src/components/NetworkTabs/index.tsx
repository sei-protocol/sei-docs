...
export function NetworkTabs({}: NetworkTabsProps) {
	...
	const linkClass =
		"text-neutral-700 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white transition-colors truncate max-w-[180px]";
	const iconButtonClass =
		"text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300 transition-colors";
	const visitLinkClass =
		"text-neutral-700 hover:text-neutral-900 dark:text-neutral-300 dark:hover:text-white flex items-center transition-colors";
		...
		<div className="network-tabs">
			<div className="flex flex-wrap gap-2 mb-6">
				<a
					...
					className={tabButtonClass("mainnet")}
				>
					Mainnet
				</a>
				<a
					...
					className={tabButtonClass("testnet")}
				>
					Testnet (atlantic-2)
				</a>
				<a
					...
					className={tabButtonClass("devnet")}
				>
					Devnet (arctic-1)
				</a>
				<a
					href="#localnet"
					onClick={() => setActiveTab("localnet")}
					className={tabButtonClass("localnet")}
				>
					Local Environment
				</a>
			</div>
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://evm-rpc.sei-apis.com"
											target="_blank"
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://rpc.pacific-1.sei.io"
											target="_blank"
											rel="noopener noreferrer"
											className={linkClass}
										>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										...
										<a
											href="https://www.seiscan.app/pacific-1"
											target="_blank"
											rel="noopener noreferrer"
											className={visitLinkClass}
										>
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://evm-rpc-atlantic-2.sei-apis.com"
											target="_blank"
											rel="noopener noreferrer"
											className={linkClass}
										>
										...
										<button
											...
											aria-label="Copy RPC URL"
											onClick={() =>
												handleCopy("https://evm-rpc-atlantic-2.sei-apis.com")
											}
										>
											<IconExternalLink className="w-4 h-4" />
										</button>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<span className={valueClass}>seitrace.com</span>
										<a
											href="https://seitrace.com/?chain=atlantic-2"
											target="_blank"
											rel="noopener noreferrer"
											className={visitLinkClass}
										>
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://rpc.atlantic-2.sei.io"
											target="_blank"
											rel="noopener noreferrer"
											className={linkClass}
										>
										...
										<button
											...
											aria-label="Copy RPC URL"
											onClick={() =>
												handleCopy("https://rpc.atlantic-2.sei.io")
											}
										>
											<IconExternalLink className="w-4 h-4" />
										</button>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<span className={valueClass}>seiscan.app</span>
										<a
											href="https://www.seiscan.app/atlantic-2"
											target="_blank"
											rel="noopener noreferrer"
											className={visitLinkClass}
										>
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://evm-rpc-arctic-1.sei-apis.com"
											target="_blank"
											rel="noopener noreferrer"
											className={linkClass}
										>
										...
										<button
											...
											aria-label="Copy RPC URL"
											onClick={() =>
												handleCopy("https://evm-rpc-arctic-1.sei-apis.com")
											}
										>
											<IconExternalLink className="w-4 h-4" />
										</button>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<span className={valueClass}>seitrace.com</span>
										<a
											href="https://seitrace.com/?chain=arctic-1"
											target="_blank"
											rel="noopener noreferrer"
											className={visitLinkClass}
										>
						...
						<div>
							...
							<div className="space-y-4">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<a
											href="https://rpc.arctic-1.sei.io"
											target="_blank"
											rel="noopener noreferrer"
											className={linkClass}
										>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										<span className={valueClass}>seiscan.app</span>
										<a
											href="https://www.seiscan.app/arctic-1"
											target="_blank"
											rel="noopener noreferrer"
											className={visitLinkClass}
										>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										...
										<button
											...
											title="Copy to clipboard"
											aria-label="Copy RPC URL"
											onClick={() => handleCopy("http://localhost:8545")}
										>
											<IconExternalLink className="w-4 h-4" />
										</button>
									</div>
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center justify-between">
										...
										<button
											...
											title="Copy to clipboard"
											aria-label="Copy RPC URL"
											onClick={() => handleCopy("http://localhost:26657")}
										>
											<IconExternalLink className="w-4 h-4" />
										</button>
									</div>
