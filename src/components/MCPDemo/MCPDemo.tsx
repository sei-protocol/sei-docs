...
export function MCPDemo() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Hi! I\'m your AI assistant powered by Sei MCP Server. Try asking me to:\n\n• Check your balance\n• Send SEI to an address\n• Analyze a contract\n• Get NFT info\n• Explore the latest block',
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <div className="w-full max-w-5xl mx-auto my-12">
      <div className="rounded-2xl overflow-hidden border border-neutral-200/50 dark:border-neutral-800/50 bg-gradient-to-br from-purple-500/5 via-blue-500/5 to-red-500/5 dark:from-purple-900/20 dark:via-blue-900/10 dark:to-red-900/20 shadow-xl">
        {/* Header */}
        ...
        <div className="h-[500px] overflow-y-auto p-6 space-y-6 scroll-smooth bg-white/30 dark:bg-neutral-950/30" style={{ scrollbarWidth: 'thin' }}>
          {messages.map((message, index) => (
            ...
            >
              ...
              {message.role === 'user' && (
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shrink-0 shadow-lg order-2">
          ...
          {isTyping && (
            <div className="flex gap-4 justify-start animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="bg-white dark:bg-neutral-800/80 backdrop-blur-sm border border-neutral-200 dark:border-neutral-700 rounded-2xl px-5 py-3 shadow-md">
        ...
        <div className="border-t border-neutral-200/50 dark:border-neutral-800/30 bg-white/50 dark:bg-neutral-900/30 p-6">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-neutral-400 disabled:to-neutral-500 text-white rounded-xl transition-all flex items-center gap-2 font-medium shadow-lg hover:shadow-xl disabled:shadow-none"
            >
