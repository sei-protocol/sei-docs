...
# The tx_hash -> block_number lookup path is intentionally unsupported.
# This field defaults to true and must remain true; setting it to false
# causes the node to panic during parquet receipt store initialization.
