...
`seid` v6.4.0 and later require Go 1.25.6 or later; v6.3.x builds with Go 1.24.5. Check
the `go.mod` at the release tag you check out
...
# then replace any previous installation — extracting over one leaves stale files behind
