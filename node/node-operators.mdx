...
# EVMSSMode consolidates the previous separate SC-layer EVM write/read routing
# modes (sc-write-mode / sc-read-mode) into a single setting. It controls how
# EVM state store data is written and read.
# Valid values: cosmos_only, dual_write, split_write
evm-ss-mode = "cosmos_only"
