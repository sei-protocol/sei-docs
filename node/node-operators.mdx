...
# path used by the parquet backend is intentionally unsupported; setting this
# to false will panic during parquet store initialization.
# defaults to true (required)
disable-tx-index-lookup = true
