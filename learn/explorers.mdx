...
<Tabs>
  <Tab title="Sei Mainnet">
    - [Seiscan](https://seiscan.io) — A user-friendly block explorer for Sei Mainnet.
  ...
  <Tab title="Sei Testnet">
    - [Seiscan](https://testnet.seiscan.io) — A user-friendly block explorer for Sei Testnet.
