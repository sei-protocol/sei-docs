...
It is <strong>highly recommended</strong> that you deploy to <em>Sei Testnet</em> first and verify everything works as expected before committing to Sei Mainnet. Doing so helps you catch bugs early, avoid unnecessary gas costs, and keep your users safe.
...
<RunSnippet method="eth_chainId" network="testnet" title="eth_chainId · Sei Testnet" description="Testnet RPC — decodes to 1328." />

<RunSnippet method="eth_chainId" network="mainnet" title="eth_chainId · Sei Mainnet" description="Mainnet RPC — decodes to 1329." />
...
To deploy the token to Sei Testnet:
...
Once you've tested your contracts, you can deploy them to Sei Testnet or Sei Mainnet. To deploy, you'll need:
