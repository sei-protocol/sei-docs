...
<RunSnippet method="eth_blockNumber" network="mainnet" title="eth_blockNumber" description="Latest committed block on Sei Mainnet. Your transaction lands a block or two after whatever this returns." />
