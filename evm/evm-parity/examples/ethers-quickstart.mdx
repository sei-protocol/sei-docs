...
Edit and re-run the full ethers code from this page live in the browser — a real ethers v6 `JsonRpcProvider` reading **Sei Testnet**, so its block number and balances won't match the mainnet reads above:

<SandboxEmbed
  kind="codesandbox"
  src="https://codesandbox.io/embed/qs82lw?view=split&hidenavigation=1&theme=dark"
  title="ethers · read Sei Testnet"
  description="A real ethers v6 provider reading Sei Testnet. Edit index.js and the preview re-runs."
/>
