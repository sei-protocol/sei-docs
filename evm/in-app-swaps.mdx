...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  ...
  <iframe className="hidden dark:block" src="https://symph.ag/embed?theme=dark" style={{ width: '100%', maxWidth: '420px', minWidth: '377px', minHeight: '680px', border: 'none', borderRadius: '12px' }} title="Symphony Swap Widget Demo (dark)" />
</div>
