...
<CardGroup cols={2}>
  ...
  <Card horizontal title="Parallel Nonce Submission for HFT" icon="bolt" href="/evm/hft/parallel-nonce-submission">
    Submit many independent orders from one funded address with EIP-7702 and ERC-4337 nonce lanes.
  </Card>
</CardGroup>
