...
<Info>Maintaining an index costs roughly one extra `SSTORE` per write (Sei: ~72,000 gas; see [EVM Differences](/evm/differences-with-ethereum#sstore-gas-cost)), but makes future clearing possible.</Info>
