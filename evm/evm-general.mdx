...
<RunSnippet method="eth_chainId" network="testnet" title="eth_chainId · Sei Testnet" description="Confirms the testnet RPC responds — decodes to 1328, the chain ID your tooling needs." />

<RunSnippet method="eth_chainId" network="mainnet" title="eth_chainId · Sei Mainnet" description="Confirms the mainnet RPC responds — decodes to 1329." />
