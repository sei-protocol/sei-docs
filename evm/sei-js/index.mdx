...
- Viem's Sei Mainnet and Sei Testnet chain definitions re-exported for convenience, plus a `seiLocal` definition for local nodes
...
Use typed chain IDs, RPC endpoints, token metadata, and wallet information for Sei Mainnet and Sei Testnet.
