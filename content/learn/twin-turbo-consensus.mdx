...
<div className="p-8 border border-neutral-700 rounded-lg bg-black shadow-md my-8">
  ...
  <div className="border-2 border-neutral-600 rounded-xl p-8 mb-10 relative">
    <div className="grid grid-cols-2 gap-0 divide-x divide-dashed divide-neutral-600">
      <div className="pr-8">
        <div className="text-center font-semibold mb-8 text-blue-400">Pre-Consensus<br/>(TX Preparation)</div>
      ...
      <div className="pl-8">
        <div className="text-center font-semibold mb-8 text-green-400">Optimized BFT Consensus<br/>(Voting & Concurrent Execution)</div>
