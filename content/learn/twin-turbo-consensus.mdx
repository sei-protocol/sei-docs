...
<Callout type="info">
  Need operator tuning guidance? See <a href="/evm/rpc-consensus-overview">Consensus Deep Dive</a> for cache sizing, vote-extension posture, and troubleshooting. This page focuses on the architectural flow.
</Callout>
