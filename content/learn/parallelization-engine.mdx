...
<div className="p-6 border border-neutral-200 dark:border-neutral-800 rounded-sm bg-neutral-50 dark:bg-neutral-950 my-8">
  ...
  <div className="grid grid-cols-3 gap-8 mb-8">
    <div className="relative">
      <div className="border border-[#600014]/20 dark:border-[#600014]/40 rounded-sm p-4">
        <div className="text-center font-semibold mb-3 text-[#600014] dark:text-[#b99ba1]">Transaction Preprocessing</div>
