---
title: "Gas"
description: "Understand gas pricing, limits, and optimization strategies for Sei transactions, with guides for sending transactions using seid, CosmJS, and EVM interfaces."
...
Sei Cosmos allows users to pay for gas fees on behalf of other users. This can be useful to cover the gas fees for users under specific circumstances. Learn more in the [Cosmos-SDK](/cosmos-sdk/fee-grants) section.
