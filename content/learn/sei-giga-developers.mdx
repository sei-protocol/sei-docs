...
<Callout type="info">This is a sneek peek on how development with Sei Giga can help improving your contract performance. Check out the beginner tutorials (here)[/evm/evm-general] to get started with Sei EVM.</Callout>
