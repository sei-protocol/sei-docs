...
Parallel execution, high throughput and unified VM operability establish Sei as
the standard for a scalable EVM and for interconnected blockchain ecosystems.

Sei’s twin-turbo consensus and SeiDB achieve 400-millisecond block times and
...
For Sei, parallelization is used to process multiple independent transactions at
the same time.
