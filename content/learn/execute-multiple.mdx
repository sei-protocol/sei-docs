...
On the Sei blockchain, you can execute multiple messages in a single
...
how you can do this using CosmJS and seid.
...
To create and broadcast a transaction with multiple messages using seid, follow
these steps:
