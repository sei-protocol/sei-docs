...
description: "Compare Sei's different network environments including devnet, testnet, mainnet, and local chains, with detailed chain IDs and purposes for each development stage."
keywords: ['sei chains', 'blockchain networks', 'sei mainnet', 'sei testnet', 'sei devnet', 'chain registry']
---
