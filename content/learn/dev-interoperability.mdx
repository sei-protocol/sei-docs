...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/interoperability.png" alt="Interoperability" caption="Enabling seamless access to all tokens and contracts on Sei" />
