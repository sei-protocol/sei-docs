...
import SeiTraceSearch from '../../src/components/AddressSearch/SeiTraceSearch';
...
After connection, you're ready to dive in, the demo below walks you through connecting to the Sei
