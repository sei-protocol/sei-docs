---
title: Creating and Managing Sei Blockchain Proposals
description: 'Comprehensive guide to Creating and Managing Sei Blockchain Proposals on Sei. Learn key concepts, commands, and best practices.'
keywords:
  - sei governance
