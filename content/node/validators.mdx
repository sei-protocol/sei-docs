...
tee "~/.sei/config/priv_validator_config.json" << EOF
{
    "chain_id": "sei-chain",
    "key_type": "yubihsm",
    "state_file": "~/.sei/data/priv_validator_state.json",
...
tar czf - ~/.sei/config/priv_validator_key.json | \
    gpg --symmetric --cipher-algo AES256 \
    -o $BACKUP_DIR/validator_key_$DATE.tar.gz.gpg

# Backup keyring
tar czf - ~/.sei/keyring-file | \
    gpg --symmetric --cipher-algo AES256 \
