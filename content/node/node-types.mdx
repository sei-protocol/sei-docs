---
title: 'Node types & ports'
description: 'Sei Nodes can fulfill a whole range of services on the Network, find out which one.'
keywords: ['sei node', 'blockchain node', 'node types', 'RPC', 'LCD', 'archive node', 'gRPC', 'P2P']
---
