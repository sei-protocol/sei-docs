...
Both methods leave you with a fully‑synced node in minutes. Verify the node is catching up (`journalctl -fu seid -o cat`) and compare the reported block height against a public RPC endpoint.
