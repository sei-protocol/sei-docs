...
# Duplicate transaction cache. Requires `sei-tendermint@02c9462f1` or newer to enforce the cap precisely.
cache-size = 10000
...
# Vote extensions removed in v0.6.4. Leave legacy flags unset.
[consensus]
...
# Deprecated (v0.5.x only; remove if present)
