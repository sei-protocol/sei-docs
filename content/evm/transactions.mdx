...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
  <a href="/evm/reference" className="group flex flex-col rounded-sm p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
    <div className="w-10 h-10 rounded-sm bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-[#600014]/10 transition-colors">
      <IconInfoCircle className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-[#600014] transition-colors" />
    </div>
...
<a href="/learn/dev-gas" className="group flex flex-col rounded-sm p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
  <div className="w-10 h-10 rounded-sm bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-[#600014]/10 transition-colors">
    <IconCoins className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-[#600014] transition-colors" />
  </div>
  ...
  <a href="/learn/accounts" className="group flex flex-col rounded-sm p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50 hover:bg-white dark:hover:bg-neutral-900 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-md transition-all h-full">
    <div className="w-10 h-10 rounded-sm bg-neutral-900/10 dark:bg-neutral-800/30 flex items-center justify-center mb-4 group-hover:bg-[#600014]/10 transition-colors">
      <IconUserCircle className="h-5 w-5 text-neutral-700 dark:text-neutral-300 group-hover:text-[#600014] transition-colors" />
    </div>
