  ...
  <table className="min-w-full divide-y divide-neutral-200 dark:divide-neutral-800">
    ...
    <tbody className="divide-y divide-neutral-200 dark:divide-neutral-800">
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400">The minimum gas price required to be included in a block. On Sei, the base fee is not burned — all fees go to validators.</td>
      </tr>
      <tr>
