---
title: 'ERC721 NFT Contract Tutorial'
description: 'Step-by-step guide to deploy an ERC721 NFT contract on Sei using Foundry, including metadata setup, minting, and contract verification.'
keywords: ['nft contract', 'erc721', 'foundry', 'smart contract deployment', 'sei blockchain']
---

import { Callout } from 'nextra/components';
import { Nfts } from '../../src/components';

# ERC721 NFT Contract Tutorial
...
<Callout type="info">You can obtain testnet tokens [from the faucet](/learn/faucet)</Callout>
