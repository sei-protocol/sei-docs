...
Prefer computing aggregates off-chain from events, or update them periodically via a dedicated maintenance transaction.
...
- Inspect execution with <a href="/evm/tracing/javascript-tracers">JavaScript tracers</a> and runtime logs.
