...
- [Creating and Deploying an Upgradeable UUPS Token](#creating-and-deploying-an-upgradeable-uups-token)
...
## Creating and Deploying an Upgradeable UUPS Token
...
const PROXY_ADDRESS = 'YOUR_PROXY_CONTRACT_ADDRESS_HERE';
