...
- [Pointer Deep Dive](/evm/pointers-deep-dive) - understand how pointer associations feed Solo and other migration flows.
- [Addr precompile](/evm/precompile-addr) - lookup associations before finalising claim payloads.
- [Indexing best practices](/evm/indexing-best-practices) - capture Solo synthetic logs reliably during large-scale migrations.
