...
If the machine you run these commands from are not running a node of the network, you'll need to append `--node http://url-to-sei-rpc` to your command. Refer to the [RPC endpoints](/) at the bottom of the for a list of RPC endpoints.
