...
<div className="not-prose mt-6 grid gap-4 md:grid-cols-2">
  ...
  <div className="rounded-xl border border-neutral-200 bg-white/90 p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900/70">
    ...
    <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-300">Ships enabled in current releases; older binaries ignore the hook, so mixed-version networks continue to make progress.</p>
