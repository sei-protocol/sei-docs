...
<td style={{padding: '12px 16px'}}><code>sei-mainnet</code></td>
</tr>
<tr>
<td style={{padding: '12px 16px'}}><strong>Chain ID</strong></td>
<td style={{padding: '12px 16px'}}><code>1329</code></td>
</tr>
<tr>
...
<td style={{padding: '12px 16px'}}><a href="https://seistream.app/">Explorer</a></td>
</tr>
<tr>
<td style={{padding: '12px 16px'}}><strong>Official Website</strong></td>
<td style={{padding: '12px 16px'}}><a href="https://www.sei.io/">Sei Website</a></td>
</tr>
<tr>
