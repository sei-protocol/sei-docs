...
description: "Integrate GoldRush APIs and tools to access structured blockchain data from Sei, including wallet balances, transactions, and cross-chain activity for your dApps and services."
keywords: ["goldrush", "covalent", "blockchain indexer", "multichain apis", "onchain data"]
---
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/goldrush/wallet_ui_component.png" alt="GoldRush UI Kit Wallet Component" caption="Example of a Wallet Component using the GoldRush UI Kit" />
