...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/create_subgraph.png" alt="Create a Subgraph" caption="Create a Subgraph" />

You will then land on your subgraph's page. All the CLI commands you need will
be visible on the right side of the page:

<ImageWithCaption
  img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/cli_commands.png"
  alt="CLI commands"
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/cli_sample.png" alt="CLI sample" caption="CLI" />
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/playground.png" alt="Playground" caption="Run your graphql query in Studio" />
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/publish_button.png" alt="Publish button" caption="Click Publish" />
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/publish_screen.png" alt="Publish screen" caption="Publish Screen" />
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/query_url.png" alt="Query URL" caption="Query URL" />
...
<ImageWithCaption img="https://cdn.sei.io/docs/assets/ecosystem/resources/the-graph/api_keys.png" alt="API keys" caption="API keys" />
