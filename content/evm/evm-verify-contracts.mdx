...
5. **[EVM Version](https://docs.blockscout.com/setup/information-and-settings/evm-version-information):** Select the correct EVM version if known, otherwise use default.
...
3. **[EVM Version](https://docs.blockscout.com/setup/information-and-settings/evm-version-information):** Select the correct EVM version if known, otherwise use default.
