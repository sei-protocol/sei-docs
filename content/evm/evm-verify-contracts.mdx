...
10. If successful, you will see a verification indicator next to **Code** in the code tab, and an additional tab called **Read Contract**. The contract name will now appear in Seitrace with any transactions related to your contract.
...
If successful, you will see a verification indicator next to Code in the code tab, and an additional tab called **Read Contract**.
