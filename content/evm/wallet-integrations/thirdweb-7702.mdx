        ...
        <div className="bg-white rounded-sm shadow-lg p-6 mb-6">
          ...
          <ConnectButton
            ...
            connectButton={{
              ...
              className:
                "!bg-indigo-600 !hover:bg-indigo-700 !text-white !py-3 !px-6 !rounded-sm !font-medium",
            }}
          />
            ...
            <div className="bg-white rounded-sm shadow-lg p-6 mb-6">
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-sm font-medium transition-colors"
                >
                  Store Custom Number
                </button>
              </div>
