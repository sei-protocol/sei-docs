...
- Rapidly prototype on-chain AI agents for SEI
- Automate DeFi strategies using a unified SDK
- Extend to custom protocols or agent logic
- Build agentic chatbots for user-facing apps
