...
<Callout type="error">**Deprecation Notice:** The native Sei Oracle is deprecated and will be shut off soon. We strongly recommend migrating to one of the third-party oracle providers listed in the [Oracles](/evm/oracles/chainlink) section, such as Chainlink, Pyth, or Redstone.</Callout>
