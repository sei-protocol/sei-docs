...
- Rewards/claim withdrawals also use 6 decimal precision (uSEI)
...
- **What are the base units and precision standards defined for SEI across operations?**
  ...
  - Queries and rewards/claim withdrawals: amounts are in 6-decimal `uSEI`.
...
- **Rewards/claims:** rewards withdrawals and distribution amounts use 6 decimals (uSEI)
