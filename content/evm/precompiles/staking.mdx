...
### **Format to 18 Decimals when Writing to Precompile and format from 6 Decimals when Reading**
...
<Callout type="warning"> **⚠️ IMPORTANT:** Undelegated tokens are subject to a **21-day unbonding period** during which they cannot be transferred and do not earn rewards. </Callout>
...
- **What it is:** If your chosen validator misbehaves (double signing, excessive downtime), a portion of your staked tokens may be slashed (currently up to 5%)
- **Mitigation:** Choose validators with high uptime (99%+) and good reputation
...
- Use valid Sei validator addresses with `seivaloper` prefix
- These are Cosmos-format addresses, not EVM addresses

### **Staking Risks**

- **Slashing:** Up to 5% of staked tokens can be lost if validator misbehaves
