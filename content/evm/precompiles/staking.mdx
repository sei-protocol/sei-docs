...
description: "Use the staking precompile to interact with Sei's staking module directly from EVM smart contracts, enabling token delegation, redelegation, and querying validator information."
keywords: ["staking precompile", "token delegation", "validator interactions", "sei staking", "redelegation"]
---
