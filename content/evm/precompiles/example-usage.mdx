...
- **Governance** (`0x0000000000000000000000000000000000001006`) - Proposal submission and voting
- **Oracle** (`0x0000000000000000000000000000000000001008`) - Price feed data access
- **JSON** (`0x0000000000000000000000000000000000001003`) - JSON data parsing
- **P256** (`0x0000000000000000000000000000000000001011`) - Verifying `P-256` elliptic curve signatures
- **Distribution** (`0x0000000000000000000000000000000000001007`) - Staking rewards and validator commissions
...
- [Staking Precompile Usage →](/precompiles/staking)
- [Governance Precompile Usage →](/precompiles/governance)
- [Oracle Precompile Usage →](/precompiles/oracle)
- [JSON Precompile Usage →](/precompiles/json)
