...
- `send`: Enables a user to send non-native [smart contract] tokens to another wallet. For
  sending native Sei [Cosmos] tokens, use `sendNative` instead.
...
- `sendNative`: Enables a user to send $SEI to another user.
  ```solidity copy
