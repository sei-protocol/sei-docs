...
- **Cross-Runtime DeFi:** Bridge EVM and CosmWasm liquidity pools and protocols.
- **Multi-Language Development:** Leverage Rust-based CosmWasm contracts from Solidity.
- **Contract Orchestration:** Coordinate complex multi-contract workflows across both runtimes.
- **Legacy Integration:** Connect existing CosmWasm contracts with new EVM applications.
...
import { COSMWASM_PRECOMPILE_ABI, COSMWASM_PRECOMPILE_ADDRESS } from '@sei-js/precompiles';
...
const cosmwasm = new ethers.Contract(COSMWASM_PRECOMPILE_ADDRESS, COSMWASM_PRECOMPILE_ABI, signer);
```
  ...
  <table className="w-full divide-y divide-neutral-200 dark:divide-neutral-800">
    ...
    <tbody className="divide-y divide-neutral-200 dark:divide-neutral-800">
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-green-600 dark:text-green-400 whitespace-nowrap">JSON bytes</td>
      ...
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400 whitespace-nowrap">msg parameter (input)</td>
        <td className="px-4 py-3 text-sm text-blue-600 dark:text-blue-400 whitespace-nowrap">JSON bytes</td>
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400">
          <code>ethers.toUtf8Bytes(jsonString)</code>
        </td>
      </tr>
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-purple-600 dark:text-purple-400 whitespace-nowrap">JSON bytes</td>
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400">
          <code>ethers.toUtf8Bytes(jsonString)</code>
        </td>
      </tr>
      <tr>
        ...
        <td className="px-4 py-3 text-sm text-orange-600 dark:text-orange-400 whitespace-nowrap">JSON bytes</td>
        <td className="px-4 py-3 text-sm text-neutral-600 dark:text-neutral-400">
...
const admin = ''; // Leave empty for no admin, or provide Sei address
