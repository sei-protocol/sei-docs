...
| Address space         | Dual addresses; sei-native Bech32 (sei…) + EVM-compatible ECDSA-derived address (0x…) | ECDSA-derived address (0x…)                                          |
...
- **Most importantly, Sei is a dual-execution environment (EVM and CosmWasm).** This means:
  ...
  - Sei assets can not only exist as EVM (i.e., ERC20/721/1155), but also as CW (i.e., CW20, CW721)
...
Sei has a gas limit of 10 M on `pacific-1`, compared to
Ethereum’s 30 M.
