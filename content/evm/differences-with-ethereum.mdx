...
<Callout type="info">💡 Interoperability between EVM and Cosmos-SDK modules is governed and navigated via [precompiles](./precompiles/example-usage) and [pointer contracts](./pointers/standard)</Callout>
