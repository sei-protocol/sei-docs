...
<Tabs items={['Integration Examples', 'Troubleshooting', 'FAQ']}>
<Tabs.Tab>
...
- All communications are **encrypted** between app and wallet
...
Sei Global Wallets are an embedded wallet experience for the Sei network, enabling wallet creation and authentication through social logins. Unlike traditional embedded wallets, Sei Global Wallets offer greater flexibility by allowing users to carry their wallets across different apps within the Sei ecosystem.
...
Sei Global Wallets support email, Google, X (Twitter), and Telegram authentication.
...
- **Verified origins:** Only verified origins can interact with Sei Global Wallets

#### Q: Are Sei Global Wallets self-custodial or custodial?

Sei Global Wallets are self-custodial, giving full control to end-users. Users can export their keys at any time and import them into other wallets, such as MetaMask.
