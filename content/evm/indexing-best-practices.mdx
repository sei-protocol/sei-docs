...
<CardGrid
  items={[
    {
      title: '@sei-js/evm indexing scripts',
      description: 'Production-ready ingestion loop with retries, checkpointing, and synthetic log metadata.',
      href: 'https://github.com/sei-protocol/sei-js/tree/main/packages/indexing'
    },
    {
      title: 'Tracing playbook',
      description: 'Understand trace limits and panic handling when debugging ingestion anomalies.',
      href: '/evm/tracing/playbook'
    },
    {
      title: 'Pointers deep dive',
      description: 'Learn how pointer metadata influences synthetic events surfaced during indexing.',
