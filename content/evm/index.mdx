...
import { IconArrowsExchange, IconBrain, IconCoins, IconCode, IconLayoutDashboard, IconTools, IconSettingsAutomation, IconPackage, IconDashboard, IconRocket, IconServer, IconChevronRight, IconBolt, IconArrowRight, IconTerminal2, IconNetwork, IconExternalLink, IconChartBar, IconBrandGithub, IconGitBranch, IconDeviceDesktop, IconClock, IconBuildingBridge, IconCloud, IconInfoCircle } from '@tabler/icons-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl p-5 bg-neutral-900/5 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/50">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="/evm/evm-transactions" className="flex items-center text-sm text-neutral-700 dark:text-neutral-300 hover:text-red-500 dark:hover:text-red-400 transition-colors">
              <IconChevronRight className="h-3 w-3 mr-1" />
              <span>EVM with Seid CLI</span>
            </a>
