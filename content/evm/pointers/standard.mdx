---
title: "TokenFactory Pointers"
description: "Create and manage pointer contracts that connect TokenFactory assets between Cosmos and EVM environments on Sei, enabling seamless token transfers and interactions."
keywords: ["tokenfactory pointers", "cross-environment tokens", "sei tokens", "evm-cosmos bridge", "token interoperability"]
---
import { Callout } from 'nextra/components';

### **First Steps**

Refer to the [Tokenfactory tutorial](/cosmos-sdk/tokenfactory-tutorial) for details
