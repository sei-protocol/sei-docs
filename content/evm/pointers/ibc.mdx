---
title: "IBC Pointers"
description: "Deploy and manage IBC pointers on Sei that enable interoperability between EVM smart contracts and IBC-connected chains, facilitating cross-chain asset transfers and communication."
keywords: ["ibc pointers", "cross-chain assets", "blockchain interoperability", "sei ibc", "token bridging"]
---
...
another blockchain to have an ERC-compatible representation within the Sei
