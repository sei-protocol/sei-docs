...
<Callout type="info" emoji={<IconInfoCircle className="h-5 w-5 mt-1" />}>
  **Quick Navigation:**
    ...
    - [Transaction Template Generation](#transaction-template-generation)
    - [Analyzing EVM Transactions](#analyzing-evm-transactions-with-cast)
    - [Template Generation Examples](#template-generation-for-different-transaction-types)
