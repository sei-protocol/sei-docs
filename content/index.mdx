...
<div className="flex justify-center mb-10">
  <a href="/evm" className="block relative group max-w-4xl w-full">
    <div className="absolute inset-0 bg-gradient-to-r from-neutral-900/80 to-neutral-900/30 dark:from-neutral-900/80 dark:to-neutral-800/30 rounded-xl transform transition-all duration-300 group-hover:scale-[1.01] group-hover:from-neutral-900/90 group-hover:to-neutral-800/40"></div>
    <div className="relative rounded-xl overflow-hidden">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-red-500/10 to-transparent"></div>
      <div className="flex flex-col md:flex-row justify-between p-7 backdrop-blur-sm">
        <div className="flex items-start gap-5 mb-6 md:mb-0">
          <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-red-500/80 to-red-700/80 flex items-center justify-center shadow-lg">
            <IconRocket className="h-6 w-6 text-white" />
          </div>
          <div className="max-w-2xl">
            <h2 className="text-lg md:text-xl font-bold text-white mb-2">Sei EVM: High-Performance Ethereum Compatibility</h2>
            <p className="text-neutral-300 mb-4 text-sm md:text-base">Explore Sei's revolutionary EVM implementation with unprecedented 600ms block times, 20,000 TPS throughput, and seamless Ethereum tooling compatibility.</p>
            <div className="flex flex-wrap gap-3">
              <a href="/evm/evm-hardhat" className="px-3 py-1.5 bg-neutral-800/50 hover:bg-neutral-700/70 rounded-lg backdrop-blur-sm transition-all flex items-center">
                <div className="w-1.5 h-1.5 rounded-full bg-red-500 mr-2"></div>
                <span className="text-sm text-white font-medium">Sei EVM with Hardhat</span>
                <IconChevronRight className="h-3.5 w-3.5 text-neutral-400 ml-1.5" />
              </a>
              <a href="/evm/evm-foundry" className="px-3 py-1.5 bg-neutral-800/50 hover:bg-neutral-700/70 rounded-lg backdrop-blur-sm transition-all flex items-center">
                <div className="w-1.5 h-1.5 rounded-full bg-red-500 mr-2"></div>
                <span className="text-sm text-white font-medium">Sei EVM with Foundry</span>
                <IconChevronRight className="h-3.5 w-3.5 text-neutral-400 ml-1.5" />
              </a>
              <a href="/evm/nft-contract-tutorial" className="px-3 py-1.5 bg-neutral-800/50 hover:bg-neutral-700/70 rounded-lg backdrop-blur-sm transition-all flex items-center">
                <div className="w-1.5 h-1.5 rounded-full bg-red-500 mr-2"></div>
                <span className="text-sm text-white font-medium">NFT Contract Tutorial</span>
                <IconChevronRight className="h-3.5 w-3.5 text-neutral-400 ml-1.5" />
              </a>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-neutral-800/70 backdrop-blur-sm group-hover:bg-neutral-700/80 transition-colors duration-300">
