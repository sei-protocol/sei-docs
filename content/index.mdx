...
<div className="mb-10">
  ...
  <div className="grid grid-cols-1 gap-4">
    <a href="/evm" className="group flex items-start justify-between rounded-xl p-6 bg-neutral-900/80 dark:bg-neutral-900/80 border border-neutral-800/80 dark:border-neutral-800/80 hover:bg-neutral-900/90 dark:hover:bg-neutral-900/90 hover:border-neutral-700 dark:hover:border-neutral-700 transition-all relative overflow-hidden">
      ...
      <div className="flex items-start gap-5 z-10">
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-red-500/60 to-red-700/60 flex items-center justify-center shadow-md">
          <IconRocket className="h-5 w-5 text-white" />
        </div>
        <div className="max-w-2xl">
          <h3 className="text-lg md:text-xl font-bold text-white mb-2">High-Performance Ethereum Compatibility</h3>
