...
<div className="flex justify-center gap-4 my-6">
  <Cards.Card icon={<Wrench />} title="Start building" href="/" />
  <Cards.Card icon={<TextCursorInput />} title="Join the ecosystem" href="https://sei-forms.typeform.com/join-ecosystem" target="_blank" />
</div>
