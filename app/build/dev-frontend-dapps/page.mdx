...
The `@sei-js` package provides various helper libraries to facilitate
interaction with the Sei blockchain. Use `@sei-js/cosmjs` and `@sei-js/proto`
for Cosmos side interactions, and `@sei-js/evm` for EVM side interactions.

- **/cosmjs**: Provides helpful wrappers around CosmJS, CosmosKit, and more;
  specifically tailored for the Cosmos side of Sei.
