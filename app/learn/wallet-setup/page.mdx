...
### Connecting Your Wallet To Sei Networks

Adding Sei your wallet takes only a few clicks. Connect your wallet
...
Sei EVM manually. Follow the steps outlined
...
Because Sei now supports two types of wallet address, it's important to
...
In order to associate your EVM and SEI addresses, you should initiate a
...
difference lies in the transaction targeting a Sei precompiled contract, where
