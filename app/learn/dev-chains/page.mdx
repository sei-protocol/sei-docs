...
The {<Code color='gray' variant='soft'>{CHAIN_IDS.mainnet}</Code>} chain is the mainnet of the Sei
...
The {<Code color='gray' variant='soft'>{CHAIN_IDS.testnet}</Code>} chain is the testnet of the Sei
...
The {<Code color='gray' variant='soft'>{CHAIN_IDS.devnet}</Code>} chain is the devnet of the Sei blockchain.
