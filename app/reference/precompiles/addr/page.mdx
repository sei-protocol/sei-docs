...
This precompile enables EVM clients to query the associated Sei address to an
...
transaction. Some Sei native wallets also provide this feature.

## Functions

### Transactions

- `associate`: Associates an EVM address with it's corresponding Sei native
...
- `associatePubKey`: Enables a user to associate a pair of sei addresses using
  the public key.
  ```solidity
