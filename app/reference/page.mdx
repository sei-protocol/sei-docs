...
import { IconInfoSquare, IconLink, IconWorld, IconBrackets, IconPointer, IconTerminal } from '@tabler/icons-react';
...
<LinkCard
  ...
  preview={{
    ...
    highlights: ['Endpoint formats', 'Common usage patterns', 'API authentication']
  }}
/>
