				...
				<Table.Body>
					<Table.Row>
						...
						<Table.Cell className='text-red-600 hover:underline'>
							<Link href='https://raw.githubusercontent.com/sei-protocol/testnet/main/pacific-1/genesis.json'>Genesis</Link>
						</Table.Cell>
					</Table.Row>
					<Table.Row>
						...
						<Table.Cell className='text-red-600 hover:underline'>
							<Link href='https://raw.githubusercontent.com/sei-protocol/testnet/main/atlantic-2/genesis.json'>Genesis</Link>
						</Table.Cell>
					</Table.Row>
					<Table.Row>
						...
						<Table.Cell className='text-red-600 hover:underline'>
							<Link href='https://raw.githubusercontent.com/sei-protocol/testnet/main/arctic-1/genesis.json'>Genesis</Link>
						</Table.Cell>
					</Table.Row>
				</Table.Body>
			</Table.Root>
