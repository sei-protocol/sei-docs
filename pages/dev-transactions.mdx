  ...
  <Tabs.Tab>
    <Paper withBorder p="md" mt="lg">
      <Flex direction="column" gap="md">
        <PropertyInfo name="body" description="The body of a transaction contains an array the messages for actions to be performed on chain." properties={[{ name: "message", description: "These are the specific actions or instructions to be executed, such as transferring tokens or interacting with a smart contract. Some common message types include '/cosmos.bank.v1beta1.MsgSend' for token transfers and '/cosmwasm.wasm.v1.MsgExecuteContract' for smart contract interactions. Transactions can batch multiple messages into one transaction and it's messages will all be executed in the same block." }]}/>
        <PropertyInfo name="auth_info" description="Authentication information includes details about the transaction’s authorization." properties={[{ name: "signer_infos", description: "Information about the transaction signers, including their public keys and sequence numbers." }, { name: "fee", description: "The fee required to execute the transaction, including the amount and denomination of tokens." }, { name: "memo", description: "An optional field for adding arbitrary text to the transaction." }]}/>
