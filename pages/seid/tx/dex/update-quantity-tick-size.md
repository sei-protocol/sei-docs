### `seid tx dex update-quantity-tick-size`
```ansi
...
Usage:
  seid tx dex update-quantity-tick-size [update-quantity-tick-size-file] [flags]
...
Flags:
  ...
  -h, --help                     help for update-quantity-tick-size
