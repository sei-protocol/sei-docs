### `seid tx gov submit-proposal migrate-contract`
```ansi
Submit a migrate wasm contract to a new code version proposal

Usage:
  seid tx gov submit-proposal migrate-contract [contract_addr_bech32] [new_code_id_int64] [json_encoded_migration_args] [flags]
