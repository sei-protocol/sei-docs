### `seid tx vesting create-vesting-account`
```ansi
...
Usage:
  seid tx vesting create-vesting-account [to_address] [amount] [end_time] [flags]

Flags:
  -a, --account-number uint      The account number of the signing account (offline mode only)
      --admin string             Add an admin to the vesting account if set
