...
The following instructions assume you have already gone through the [Run a Sei Node](/running-sei-node/quickstart) and are synchronized to the latest block height.
...
Only validators in the **Active Validator Set** are the only validators that sign blocks and receive revenue.
