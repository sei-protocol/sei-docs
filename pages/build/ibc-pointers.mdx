...
- **Governance proposal submission permissions** (access to an account with sufficient voting power or delegation).
- **Token metadata** (including the token denomination, name, symbol, and decimals).
- **Sufficient deposit** to submit a proposal for governance consideration.
