---
title: "Interact with EVM on Sei via CLI | Sei Docs"
description: "Use the seid CLI to query addresses, deploy EVM contracts, and manage tokens in Sei's EVM environment seamlessly."
keywords: ["sei docs", "cli", "evm", "contracts", "web3 docs"]
---
