...
- the source channel and port id
  ...
  - These could be located in [registry](https://github.com/sei-protocol/chain-registry/blob/main/ibc_info.json). E.g. for {<Code>{CHAIN_IDS.testnet}</Code>} Axelar, we would use:
