---
title: "Using Ledger with Ethers.js | Sei Docs"
description: "Set up and manage a Ledger hardware wallet on Sei with Ethers.js. Learn how to send funds, stake, and sign transactions securely."
keywords: ["sei docs", "ledger wallet", "ethers", "hardware wallet", "web3 docs"]
---
...
2. Enable blind signing in the Ethereum app settings (needed for precompile examples and working with contracts in general).
3. Linux users may need to add a udev rule to allow access to the device. You can find the script to add a rule in the Ledger repo [here](https://github.com/LedgerHQ/udev-rules).
