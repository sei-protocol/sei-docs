---
title: "IBC Relayer | Sei Docs"
description: "Set up Hermes or Go relayers to link Sei with other Cosmos chains, enabling cross-chain data and token transfers."
keywords: ["sei docs", "ibc relayer", "cosmos", "cross-chain", "web3 docs"]
---
