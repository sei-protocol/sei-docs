---
title: "IBC Overview | Sei Docs"
description: "Discover the Inter-Blockchain Communication (IBC) protocol for seamless cross-chain data transfer. Explore how Sei leverages IBC for the first parallelized EVM blockchain."
keywords: ["sei docs", "ibc", "cross-chain", "interoperability", "web3 docs"]
---
...
- the source channel and port id
  ...
  - These could be located in [registry](https://github.com/sei-protocol/chain-registry/blob/main/ibc_info.json). E.g. for `{CHAIN_IDS.testnet}` Axelar, we would use:
