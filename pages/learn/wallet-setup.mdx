...
**For complete functionality, it is recommended to use one of the wallets listed on the [Wallets Page](../providers/wallets/wallets.mdx)**

<Callout type='warning'>
	**Attention:** Manually importing your wallet using a mnemonic from an EVM-only wallet app to a Cosmos based wallet app, or vice versa is not recommended. This
	may generate unexpected wallet address due to differing [cointypes](https://en.bitcoin.it/wiki/BIP_0044#Coin_type).
</Callout>
...
<Callout type='info'>Visit our [Pointer Contract page](../dev-tutorials/pointer-contracts.mdx) to learn more.</Callout>
