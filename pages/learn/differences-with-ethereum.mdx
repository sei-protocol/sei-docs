...
Sei supports all transaction types. However, Sei's base fee **does not** fluctuate due to block congestion. The base fee will always be `0` on Sei—all fees will go to the validators (i.e. tips) and none will be burnt.
