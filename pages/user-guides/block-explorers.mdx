...
Rather than downloading the entire blochain ledger, using a block explorer is the most common method to look up all kinds of useful on-chain information.
...
> :warning: **Note**: *In rare cases, some information may be misinterpreted. Off-chain data should be used as a guide only*.
