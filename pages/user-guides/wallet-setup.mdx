...
import ComapassIcon from "../../public/assets/compass_icon.png";
import MeatamaskIcon from "../../public/assets/metamask_icon.jpg";

## Create a Wallet and Sign Transactions

Two common ways to create a sei wallet are:
<ImageWithCaption img={ComapassIcon} alt="compass icon" width= 50 height= 50 />
