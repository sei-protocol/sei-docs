...
import linkAddresses from "../../public/assets/link-addresses.png";
...
3. Click the "Link Addresses" button. This will prompt you to sign a message with your wallet - it's not a transaction, and will not charge you any gas fees.
<ImageWithCaption img={linkAddresses} alt="Link addresses button"/>
