...
Note: you will require at least 1 SEI token in your wallet to link your addresses.

1. Navigate to https://app.sei.io/ using your web browser.
2. On the Dashboard, look for the "Addresses" box.
3. Click the "Sign Message" button. This will prompt you to sign a message with your wallet - it's not a transaction, and will not charge you any gas fees.
<ImageWithCaption img={signMessageImage} alt="Sign message button"/>
