---
title: "Join a Network | Sei Docs"
description: "Connect your node to Sei’s devnet, testnet, or mainnet with state sync and peer discovery for quick syncing."
keywords: ["sei docs", "join network", "state sync", "testnet", "web3 docs"]
---
