---
title: "Quick Start | Sei Docs"
description: "Use the run-node.py script to rapidly install, configure, and launch a Sei node or local testnet with minimal steps."
keywords: ["sei docs", "quick start", "installation", "testnet", "web3 docs"]
---
