---
title: "Local Sei Node | Sei Docs"
description: "Set up and run a local single-node Sei testnet for development. Explore scripts, Docker, and multi-node clusters."
keywords: ["sei docs", "local node", "docker", "testnet", "web3 docs"]
---
