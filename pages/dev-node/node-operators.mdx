...
1. Download the `statesync_config.sh` script from the repository:

    ```bash
    mkdir -p ~/sei-chain/scripts
wget -O ~/sei-chain/scripts/statesync_config.sh https://raw.githubusercontent.com/sei-protocol/sei-docs/refs/heads/main/scripts/statesync_config.sh
    chmod +x ~/sei-chain/scripts/statesync_config.sh
    ```

2. Run the state sync script:

    ```bash
    ~/sei-chain/scripts/statesync_config.sh https://rpc.sei-apis.com
    ```
