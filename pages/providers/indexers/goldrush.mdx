---
title: "GoldRush - Powered by Covalent | Sei Docs"
description: "Leverage Covalent’s GoldRush APIs, SDKs, and UI kits to access, decode, and display onchain data for Sei’s EVM environment."
keywords: ["sei docs", "covalent", "goldrush", "indexing", "web3 docs"]
---
...
- **Use cases:** [Custom block explorers](https://goldrush-block-explorer-ui.vercel.app/?utm_source=sei&utm_medium=partner-docs).
...
2. [GoldRush SDKs](https://goldrush.mintlify.app/docs/goldrush-sdks?utm_source=sei&utm_medium=partner-docs) - official client libraries including TypeScript and Python. 
    ```sh
...
- [Docs](https://goldrush.dev/docs/?utm_source=sei&utm_medium=partner-docs) - comprehensive knowledge base for all things GoldRush including a quickstart
- [Sei Network Details](https://goldrush.dev/chains/sei/?utm_source=sei&utm_medium=partner-docs) - setup details and supported APIs for Sei
- [Guides](https://goldrush.dev/guides/?utm_source=sei&utm_medium=partner-docs) - learn how to build for various use cases and expand your onchain knowledge
