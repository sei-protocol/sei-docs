---
title: "The Graph | Sei Docs"
description: "Index and query Sei smart contract data using subgraphs. Set up, deploy, and publish your subgraph for dApps."
keywords: ["sei docs", "the graph", "subgraphs", "indexing", "web3 docs"]
---
