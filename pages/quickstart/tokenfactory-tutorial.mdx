...
<Callout type="warning">
    ...
    ```
    `--coin-type` flag is used to specify the coin type, defined in BIP44 standard (used for address derivation).
    Ethereum (EVM) based coins are assigned type `60`. Sei is of type `118`.
