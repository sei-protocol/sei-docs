...
- Sei tokens [from an exchange](/onboard/getting-tokens), or stablecoins in your personal wallet.

For additional help with wallet apps, see our [Setting up a Wallet](/onboard/wallet-setup) guide.
...
For more details, check the [Linking Addresses guide](/onboard/linking-addresses).
