...
This section details the key components and technologies of the core chain. Alongside standard SDK modules, Sei supports both CosmWasm and EVM smart contracts, with a unique interoperability solution enabling both to coexist on the same consensus layer.
