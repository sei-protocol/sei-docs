...
file. The following default parameters are included:
	...
	delegation amount:           100000000usei
	commission rate:             0.1
...
Usage:
  seid gentx [key_name] [amount] [flags]
...
Flags:
  ...
  -h, --help                                help for gentx
      ...
      --ip string                           The node's public IP (default "192.168.0.160")
  ...
  -o, --output string                       Output format (text|json) (default "json")
      ...
      --p2p-port string                     The node's public IP port (default "26656")
