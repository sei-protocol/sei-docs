...
Usage:
  seid tx dex register-contract [contract address] [code id] [(deprecated)] [need order matching] [deposit] [dependency1,dependency2,...] [flags]
...
Flags:
  ...
  -h, --help                     help for register-contract
