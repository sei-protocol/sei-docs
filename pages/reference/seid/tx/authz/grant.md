...
Usage:
  seid tx authz grant <grantee> <authorization_type="send"|"generic"|"delegate"|"unbond"|"redelegate"> --from <granter> [flags]
...
Flags:
  ...
  -b, --broadcast-mode string        Transaction broadcasting mode (sync|async|block) (default "sync")
      ...
      --expiration int               The Unix timestamp. Default is one year. (default 1749883910)
