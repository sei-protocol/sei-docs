### `seid tx gov submit-proposal update-resource-dependency-mapping`
```ansi
...
Usage:
  seid tx gov submit-proposal update-resource-dependency-mapping [proposal-file] [flags]
...
Flags:
  ...
  -h, --help                     help for update-resource-dependency-mapping
