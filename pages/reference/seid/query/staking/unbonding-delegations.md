### `seid query staking unbonding-delegations`
```ansi
Query unbonding delegations for an individual delegator.

Example:
$ <appd> query staking unbonding-delegations sei1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

Usage:
  seid query staking unbonding-delegations [delegator-addr] [flags]
