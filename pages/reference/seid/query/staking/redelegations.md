### `seid query staking redelegations`
```ansi
Query all redelegation records for an individual delegator.

Example:
$ <appd> query staking redelegation sei1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

Usage:
  seid query staking redelegations [delegator-addr] [flags]
