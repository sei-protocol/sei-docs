---
title: "EVM RPC Endpoints | Sei Docs"
description: "Use Sei’s JSON-RPC interface for EVM, including eth_call, eth_sendRawTransaction, debug_trace, and more."
keywords: ["sei docs", "evm rpc", "json-rpc", "ethereum compatibility", "web3 docs"]
---
...
Note: The storage proofs in the return object follow this [format](https://github.com/sei-protocol/sei-tendermint/blob/main/proto/tendermint/crypto/proof.pb.go#L272-L274).
