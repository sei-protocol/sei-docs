---
name: sei-network
description: Skills for interacting with the Sei blockchain, including account queries, token transfers, smart contract interaction, staking, and transaction monitoring.
license: MIT
compatibility: Requires an RPC URL and explicit signer confirmation for write operations.
metadata:
  author: Sei
  version: "1.0"
---
